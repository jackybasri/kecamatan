...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Destinasi</h1>        
    </div>
<div class="col-lg-8">
    ...
    <form action="/dashboard/destinasi" method="post" enctype="multipart/form-data">
      @csrf
        ...
        <div class="mb-3">
          ...
          <select class="form-select" name="destinasi_kategori_id" required>

            <option selected>Pilih Kategori</option>
            @foreach ($categories as $c )
            @if (old('destinasi_kategori_id') == $c->judul)
        ...
        <div class="mb-3">
          <label for="isi" class="form-label">Destinasi</label>
          <input id="isi" type="hidden" name="isi" value="{{ old('isi') }}">
          <trix-editor input="isi"></trix-editor>

         @error('isi')
         <p class="text-danger">Destinasi Harus Diisi</p>
         @enderror
