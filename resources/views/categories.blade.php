  ...
  <div class="container">
       <div class="row">
            ...
            <div class="col-lg-12 col-12 py-5 mt-5 mb-3 text-center">
              ...
              <h1 class="mb-4" data-aos="fade-up">Kategori Berita</h1>
            </div>

            <div class="col-lg-7 col-md-7 col-12 mb-4">
              <div class="blog-header" data-aos="fade-up" data-aos-delay="100">
                <img src="/img/rupiah.jpg" class="img-fluid" alt="blog header">

                <div class="blog-header-info">
                  <h4 class="blog-category text-info">{{ $categories[0]->judul }}</h4>
            ...
            <div class="col-lg-5 col-md-5 col-12 mb-4">
              <div class="blog-sidebar d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="blog-info">
                  <h4 class="blog-category text-danger">Economy</h4>
              ...
              <div class="blog-sidebar d-flex justify-content-center align-items-cen ter" data-aos="fade-up" data-aos-delay="200">
